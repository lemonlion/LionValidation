...
{
    /// <summary>
    /// Validates the property isn't null or empty if any of the named properties listed don't match the regular expression provided.
    /// </summary>
    public class RequiredIfAnyRegexNotMatchAttribute : RequiredIfAttribute
    {
        /// <summary>
        /// Validates the property isn't null or empty if any of the named properties listed don't match the regular expression provided.
        /// </summary>
        ...
        public RequiredIfAnyRegexNotMatchAttribute(string regularExpression, string dependantFieldName)
        ...
        public RequiredIfAnyRegexNotMatchAttribute(string regularExpression, string dependantFieldName1, string dependantFieldName2)
            : base(dependantFieldName1, Operator.FailsRegularExpression, regularExpression, AndOr.Or,
        ...
        public RequiredIfAnyRegexNotMatchAttribute(string regularExpression, string dependantFieldName1, string dependantFieldName2, string dependantFieldName3)
            : base(dependantFieldName1, Operator.FailsRegularExpression, regularExpression, AndOr.Or,
                   dependantFieldName2, Operator.FailsRegularExpression, regularExpression, AndOr.Or,
        ...
        public RequiredIfAnyRegexNotMatchAttribute(string regularExpression, string dependantFieldName1, string dependantFieldName2, string dependantFieldName3, string dependantFieldName4)
            : base(dependantFieldName1, Operator.FailsRegularExpression, regularExpression, AndOr.Or,
                   dependantFieldName2, Operator.FailsRegularExpression, regularExpression, AndOr.Or,
                   dependantFieldName3, Operator.FailsRegularExpression, regularExpression, AndOr.Or,
        ...
        public RequiredIfAnyRegexNotMatchAttribute(string regularExpression, string dependantFieldName1, string dependantFieldName2, string dependantFieldName3, string dependantFieldName4,
            ...
            : base(dependantFieldName1, Operator.FailsRegularExpression, regularExpression, AndOr.Or,
                   dependantFieldName2, Operator.FailsRegularExpression, regularExpression, AndOr.Or,
                   dependantFieldName3, Operator.FailsRegularExpression, regularExpression, AndOr.Or,
                   dependantFieldName4, Operator.FailsRegularExpression, regularExpression, AndOr.Or,
        ...
        public RequiredIfAnyRegexNotMatchAttribute(string regularExpression, string dependantFieldName1, string dependantFieldName2, string dependantFieldName3, string dependantFieldName4,
            ...
            : base(dependantFieldName1, Operator.FailsRegularExpression, regularExpression, AndOr.Or,
                   ...
                   dependantFieldName3, Operator.FailsRegularExpression, regularExpression, AndOr.Or,
                   dependantFieldName4, Operator.FailsRegularExpression, regularExpression, AndOr.Or,
                   dependantFieldName5, Operator.FailsRegularExpression, regularExpression, AndOr.Or,
        ...
        public RequiredIfAnyRegexNotMatchAttribute(string regularExpression, string dependantFieldName1, string dependantFieldName2, string dependantFieldName3, string dependantFieldName4,
            ...
            : base(dependantFieldName1, Operator.FailsRegularExpression, regularExpression, AndOr.Or,
                   ...
                   dependantFieldName4, Operator.FailsRegularExpression, regularExpression, AndOr.Or,
                   dependantFieldName5, Operator.FailsRegularExpression, regularExpression, AndOr.Or,
                   dependantFieldName6, Operator.FailsRegularExpression, regularExpression, AndOr.Or,
